...
export default function HomeSection() {
    ...
    return (
        <div className="p-6 flex ml-32 flex-col items-start mt-24 max-w-7xl antialiased">
            ...
            <div className="text-neutral-300 text-3xl mb-3 space-y-1 ">Surge Bot simplifies meeting management by recording entire sessions and generating accurate transcriptions for  <FlipWords className="text-white" words={words} duration={3000}/></div>
